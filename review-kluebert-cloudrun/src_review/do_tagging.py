...
from modeling.trainer import tag_fn, tag_valid_fn, valid_eval_fn ### 함수import 수정
...
if __name__ == "__main__":
    ...
    # ===================================================
    parser.add_argument("--tagging_fp", type=str, help="태깅할 데이터들이 포함된 디렉토리 경로 or 태깅할 데이터 파일 경로 설정", default="./resources_review/data_untagged_json/")
    ### path 수정
